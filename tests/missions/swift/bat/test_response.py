...
as_rsp = data_path / 'swift-bat' /'sw00974827000bevas.rsp.gz'
ps_rsp = data_path / 'swift-bat' /'sw00974827000bevps.rsp.gz'
...
class TestBatRsp_As(unittest.TestCase):
    ...
    def test_write(self):
        with TemporaryDirectory() as this_path:
            ...
            rsp = BatRsp.open(os.path.join(this_path, self.rsp.filename))
