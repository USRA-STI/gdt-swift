...
The GDT-Swift package can be installed from PyPI using:
...
If you want to download the Swift Bat test/tutorial data only, for example:

.. code-block:: sh

    gdt-data download swift-bat
...
mission.  To access the Swift BAT test data directory:

    >>> from gdt.core import data_path
    >>> bat_path = data_path.joinpath('swift-bat')

Once you are done using the data, you can delete the data files with the following command:

.. code-block:: sh

   gdt-data clean swift-bat
...
Quickstart
----------
To load the GDT-swift package within your python environment, simply::
...
.. code-block:: sh
    ...
    gdt-data clean gdt-swift
    pip uninstall astro-gdt-swift
